...
const FinalSurprise = () => {
  ...
  return (
    <div className="relative flex flex-col items-center justify-center h-screen text-center overflow-hidden">
      ...
      <motion.h1 className="text-6xl font-bold text-gray-200 font-[Poppins]">
        🎁 Here's Your Surprise! 🎁
      </motion.h1>
      <motion.p className="mt-6 text-2xl italic text-gray-300" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 1.5 }}>
      ...
      <motion.button 
        ...
        className="px-8 py-4 rounded-xl shadow-lg transition-all duration-300 bg-green-500 text-white text-lg font-semibold hover:bg-green-600 hover:scale-105 active:scale-95 mt-4"
